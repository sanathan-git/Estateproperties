    ...
    <section>
      <div className='container mx-auto min-h-[800px] mb-14'>
        <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
          ...
          <div className='mb-4 lg:mb-0 flex gap-x-2 test-sm'>
            <div className='bg-green-500 bg-white px-3 rounded-full'>{house.type}</div>
            <div className='bg-violet-500 bg-white px-3 rounded-full'>{house.country}</div>
          </div>
        ...
        <div className='flex flex-col items-start gap-8 lg:flex-row'> 
          ...
          <div className='flex-1 bg-white border border-gray-300 rounded-lg px-6 py-8'>
            ...
            <form  className='flex flex-col gap-y-4'>
              ...
              <input className='border border-gray-300 focus:border-violet-700 outline-none rounded w-full px-4 h-14 text-sm' 
               ...
               placeholder='Phone*'
               />
              <textarea className='border border-gray-300 focus:border-violet-700 outline-none resize-none 
